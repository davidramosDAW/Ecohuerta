        ...
        <section id="consulta_productor">
            ...
            <table id="tablaformu">
                <form  name="consulta_productos" class="formu" method="post" action="#">
                    ...
                    <tr>
                        <td colspan="2"><button id="Consultar" name="Consultar" >Consultar</button>
                            <button id="Consultar" name="Consultar_todos">Consultar Todos</button></td>
                    </tr>
...
function realizar_consulta($flag){
    ...
    if ($flag===1)
    {
        ...
        echo "Por favor, rellene los campos para ejecutar la consulta";
