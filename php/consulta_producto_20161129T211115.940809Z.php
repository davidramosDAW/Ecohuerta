...
<div id="contenedor">
    ...
    <article>
        ...
        <section id="consulta_productor">
                ...
                <form name="consulta_productos" class="formu" method="post" action="#">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <button id="Consultar" name="Consultar_todos_productos">Consultar Todos</button>
                        </td>
                    </tr>
                </form>
            </table>
            ...
            <?php
            if (isset($_POST['Consultar_todos_productos'])) {
            ...
            if (isset($_POST['Consultar_producto'])) {
                if (($_POST['select_productores']==="nulos") && ($_POST['select_producto_familia']==="nulos") && ($_POST['select_producto_tipo']==="nulos")){
                    echo "<h2 align='center'> Por favor, rellene algún campo para ejecutar la búsqueda.</h2>";
                }else {
...
function genera_salida($salida)
{
    if ($salida != " ") {
        ...
        echo "<h2 align='center'> No existen registros para la consulta ejecutada.</h2>";
    }
}
